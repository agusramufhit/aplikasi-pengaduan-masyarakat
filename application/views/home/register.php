					...
					<div class="col-lg-7">
						<div class="card shadow-lg border-0 rounded-lg mt-5">
									...
									<div class="form-row">
										...
										<div class="col-md-6">
											<div class="form-group"><label class="small mb-1"
													...
													placeholder="Masukan kembali password" name="confirm_password" />
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<input class="form-control py-4" id="no_telp" type="number"
											aria-describedby="emailHelp" placeholder="Masukan No telepon" name="telp" />
									</div>
									<div class="form-row">
							...
							<div class="card-footer text-center">
								<div class="small"><a href="<?= base_url('auth/login') ?>">Sudah punya akun? login</a>
								</div>
							</div>
						</div>
					</div>
