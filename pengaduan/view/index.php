      ...
      <div class="col-xl-12 col-lg-12 col-md-9">
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-7 d-none d-lg-block align-items-center justify-content-center d-flex"style="background-color: #293c74">
                <img class="img-fluid"
              ...
              <div class="col-lg-5">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h1 class="animated--grow-in" style="border-radius: 5px;font-size: 20px;margin-bottom: -40px; margin-top: -10px; text-decoration:none;color:white;background-color:#293c74;text-align:center;"><b>Di Layanan Pengaduan Masyarakat Kantor Kecamatan Tanjungpinang Timur</b></h1><br>
                  </div>
...
?>
                  ...
                  <hr/>
                  <div class="text-center">
                   <a class="small" href="register.php" style="text-decoration: none">Buat Akun!</a><p><a href="../../" style="text-decoration: none">Kembali ke Home</a></p>
                  </div>
                </div>
              </div>
            </div>
