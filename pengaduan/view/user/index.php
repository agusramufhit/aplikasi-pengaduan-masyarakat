...
<?php
  $proses = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pengaduan WHERE status='proses' and nik='$data[nik]'"));
  $belumditanggapi = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pengaduan WHERE status='0' and nik='$data[nik]'"));
  $selesai = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pengaduan WHERE status='selesai' and nik='$data[nik]'"));
  $jumlah = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pengaduan WHERE nik='$data[nik]'"));
  if(empty($jumlah)){
    error_reporting(0);
  }
?>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy;Kantor Kecamatan tgp.timur_2021</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
